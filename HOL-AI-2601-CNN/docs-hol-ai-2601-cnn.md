...
For the detailed Pyhon scripts, please check 
...
1. Train model by cats and dogs images.
2. Make prediction on multiple images that to predict from own images from 1.jpg to 9.jpg.
3. Save the model as hol_ai_2601_cnn_cats_dogs_classifier_0226.keras.
